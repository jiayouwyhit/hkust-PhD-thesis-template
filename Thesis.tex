...
\title{Thesis title}
\author{Name}     % Author of the thesis.
...
\depthead{head}    % acting department head.
\defencedate{2014}{11}{16}      % \defencedate{year}{month}{day}.
...
\acknowledgments
%\input{TexFile/Ack}
acknowledgments acknowledgments acknowledgments acknowledgments acknowledgments acknowledgments acknowledgments acknowledgments acknowledgments acknowledgments acknowledgments acknowledgments acknowledgments acknowledgments acknowledgments acknowledgments 
